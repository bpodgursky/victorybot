...
import heuristic.Heuristic.OrderGenerationHeuristic;

public class NaiveOrderGeneration extends OrderGenerationHeuristic {
	...
	public NaiveOrderGeneration(Heuristic baseHeuristic) {
		super(baseHeuristic);
	}
